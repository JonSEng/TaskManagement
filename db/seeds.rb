...
Task.create([
  { :title => "Sweep", :lead_worker_id => 15, :notes => "dry swiffers and push brooms can be found in supply room near bathrooms", :workers_that_finished_me => "", :task_session_id => 1, :task_template_id => nil, :created_at => "2014-01-08 04:09:44", :updated_at => "2014-01-08 07:34:06", :min_workers => 2, :max_workers => 3 },
  { :title => "Trash Maintenance", :lead_worker_id => 11, :notes => "Trash bags can be found in the General Supplies Room", :workers_that_finished_me => "", :task_session_id => 1, :task_template_id => nil, :created_at => "2014-01-08 06:22:55", :updated_at => "2014-01-08 07:33:24", :min_workers => 1, :max_workers => 2 },
  { :title => "Tidy Up Rooms", :lead_worker_id => -1, :notes => "MPR, Foyer, Quiet Room, Glass Room, Meeting Room 1, 2, 3 and 4 ", :workers_that_finished_me => "", :task_session_id => 1, :task_template_id => nil, :created_at => "2014-01-08 06:26:23", :updated_at => "2014-01-08 06:28:38", :min_workers => 3, :max_workers => 3 },
  { :title => "Bathrooms", :lead_worker_id => 12, :notes => "Men’s, Women’s upstairs and downstairs ", :workers_that_finished_me => "", :task_session_id => 1, :task_template_id => nil, :created_at => "2014-01-08 06:33:00", :updated_at => "2014-01-08 06:57:58", :min_workers => 3, :max_workers => 4 },
  { :title => "Sweep", :lead_worker_id => -1, :notes => "dry swiffers and push brooms can be found in supply room near bathrooms", :workers_that_finished_me => "", :task_session_id => nil, :task_template_id => 1, :created_at => "2014-01-08 06:38:00", :updated_at => "2014-01-08 06:38:00", :min_workers => 2, :max_workers => 3 },
  { :title => "Trash Maintenance", :lead_worker_id => -1, :notes => "Trash bags can be found in the General Supplies Room", :workers_that_finished_me => "", :task_session_id => nil, :task_template_id => 1, :created_at => "2014-01-08 06:38:00", :updated_at => "2014-01-08 06:38:00", :min_workers => 1, :max_workers => 2 },
  { :title => "Tidy Up Rooms", :lead_worker_id => -1, :notes => "MPR, Foyer, Quiet Room, Glass Room, Meeting Room 1, 2, 3 and 4 ", :workers_that_finished_me => "", :task_session_id => nil, :task_template_id => 1, :created_at => "2014-01-08 06:38:00", :updated_at => "2014-01-08 06:38:00", :min_workers => 3, :max_workers => 3 },
  { :title => "General Supplies Room ", :lead_worker_id => -1, :notes => "", :workers_that_finished_me => "", :task_session_id => nil, :task_template_id => 1, :created_at => "2014-01-08 06:38:00", :updated_at => "2014-01-08 06:38:00", :min_workers => 1, :max_workers => 1 },
  { :title => "Bathrooms", :lead_worker_id => -1, :notes => "Men’s, Women’s upstairs and downstairs ", :workers_that_finished_me => "", :task_session_id => nil, :task_template_id => 1, :created_at => "2014-01-08 06:38:00", :updated_at => "2014-01-08 06:38:00", :min_workers => 3, :max_workers => 4 },
  { :title => "General Supplies Room ", :lead_worker_id => 9, :notes => "", :workers_that_finished_me => "Yubo Diwu", :task_session_id => 1, :task_template_id => nil, :created_at => "2014-01-08 07:31:18", :updated_at => "2014-01-08 07:33:50", :min_workers => 1, :max_workers => 1 }
])
