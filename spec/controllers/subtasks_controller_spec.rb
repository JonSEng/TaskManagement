  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved subtask as @subtask" do
        ...
        post :create, {:subtask => { "title" => "invalid value" }}, valid_session
        assigns(:subtask).should be_a_new(Subtask)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subtask" do
        ...
        Subtask.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => subtask.to_param, :subtask => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the subtask as @subtask" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Subtask.any_instance.stub(:save).and_return(false)
        put :update, {:id => subtask.to_param, :subtask => { "title" => "invalid value" }}, valid_session
        assigns(:subtask).should eq(subtask)
      end
